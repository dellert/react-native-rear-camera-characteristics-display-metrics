...
public class RNRearCameraCharacteristicsDisplayMetricsModule extends ReactContextBaseJavaModule {
    ...
    public Map<String, Object> getConstants() {
        ...
        try {
            ...
            var level = cameraCharacteristics.get(cameraCharacteristics.CameraCharacteristics.INFO_SUPPORTED_HARDWARE_LEVEL);
            canCamera2Api = level == CameraCharacteristics.INFO_SUPPORTED_HARDWARE_LEVEL_3 || level == CameraCharacteristics.INFO_SUPPORTED_HARDWARE_LEVEL_FULL
        } catch (Exception e) {
            ...
            constants.put("CAN_CAMERA2API", canCamera2Api);
        }
        return constants;
    }
}